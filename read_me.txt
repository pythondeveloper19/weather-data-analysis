Overview
--------
Solution of Problem Statements of Weather Data of last 30 years in python.
...
Problem 2
---------
Calculate the following values for every year for every station, ignoring missing data:
